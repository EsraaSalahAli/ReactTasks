...
function Favourite() {
    const favorites = useSelector((state) => state.FavRed.favorites);
                        ...
                        <div className="card mb-3" style={{ width: "16rem" }} key={index}>
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">
                                    <small className="text-muted me-4">{movie.release_date}</small>
                                    <button onClick={(e) => HandleRemove(e, movie.id)} className='btn btn-outline-danger'><i class="fa-solid fa-trash"></i></button>
                                </p>
